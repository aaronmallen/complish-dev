...
Complish is a personal productivity CLI tool designed around a core principle: **you should be able to recall what you
...
Complish starts as a command-line tool for power users and developers who live in the terminal. The CLI provides the
core functionality and serves as the foundation for future development.

Future releases will expand to additional platforms:
...
- **Web Interface**: Browser-based access for teams and non-CLI users

The CLI will always remain a first-class citizen, with new features developed CLI-first before expanding to other
platforms.
